...
#ifndef __QUERY_MAIN_CMDLINE_HPP__
#define __QUERY_MAIN_CMDLINE_HPP__
...
public:
  ...
  const char *                   file_arg;
  ::std::vector<const char *>    mers_arg;
  typedef ::std::vector<const char *>::iterator mers_arg_it;
  typedef ::std::vector<const char *>::const_iterator mers_arg_const_it;
  ...
  query_main_cmdline(int argc, char* argv[]) :
    sequence_arg(), sequence_given(false),
    output_arg(""), output_given(false),
    interactive_flag(false),
    file_arg(""),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUs:o:i";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    for( ; optind < argc; ++optind) {
      mers_arg.push_back(argv[optind]);
    }
  }
  static const char * usage() { return "Usage: jellyfish query [options] file:path mers:string+"; }
  class error {
    int code_;
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    os << "sequence_given:" << sequence_given << " sequence_arg:" << vec_str(sequence_arg) << "\n";
...
#endif // __QUERY_MAIN_CMDLINE_HPP__"
