...
#ifndef __DUMP_MAIN_CMDLINE_HPP__
#define __DUMP_MAIN_CMDLINE_HPP__
...
public:
  ...
  dump_main_cmdline(int argc, char* argv[]) :
    column_flag(false),
    tab_flag(false),
    lower_count_arg(), lower_count_given(false),
    upper_count_arg(), upper_count_given(false),
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: jellyfish dump [options] db:path"; }
  class error {
    int code_;
...
#endif // __DUMP_MAIN_CMDLINE_HPP__"
