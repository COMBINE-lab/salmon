...
curl -k -L https://github.com/COMBINE-lab/RapMap/archive/selective-alignment.zip -o ${EXTERNAL_DIR}/rapmap.zip

rm -fr ${EXTERNAL_DIR}/RapMap
unzip ${EXTERNAL_DIR}/rapmap.zip -d ${EXTERNAL_DIR}
mv ${EXTERNAL_DIR}/RapMap-selective-alignment ${EXTERNAL_DIR}/RapMap
...
cp -r ${EXTERNAL_DIR}/RapMap/include/spdlog ${INSTALL_DIR}/include/rapmap
cp -r ${EXTERNAL_DIR}/RapMap/include/btree ${INSTALL_DIR}/include/rapmap
