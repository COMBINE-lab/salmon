...
/usr/bin/time -o $tfile $ALVBIN alevin -lISR --end 5 --barcodeLength 16 --umiLength 10  -1 /mnt/scratch5/avi/alevin/data/10x/v2/mohu/100/all_bcs.fq -2 /mnt/scratch5/avi/alevin/data/10x/v2/mohu/100/all_reads.fq -o $OUT/prediction -i /mnt/scratch5/avi/alevin/data/mohu/salmon_index/ -p 20 --tgMap /mnt/scratch5/avi/alevin/data/mohu/gtf/txp2gene.tsv  --dumpFeatures --dumpUmiGraph --dumpBarcodeMap ##--numCellBootstraps 100  --dumpBfh --dumpBarcodeEq  --dumpCsvCounts  --expectCells 1001  --end 6 --umiLength 10 --barcodeLength 16 
