...
/usr/bin/time -o $tfile $ALVBIN alevin -lISR --chromium -1 /mnt/scratch5/avi/alevin/data/10x/v2/mohu/100/all_bcs.fq -2 /mnt/scratch5/avi/alevin/data/10x/v2/mohu/100/all_reads.fq -o $OUT/prediction -i /mnt/scratch5/mappings-matter/salmon_full_gentrome_k23_kdp -p 20 --tgMap /mnt/scratch5/mappings-matter/t2g1.txt --dumpMtx --no-version-check --dumpFeatures #--dumpBfh --whitelist /mnt/scratch5/avi/alevin/bin/salmon/tests/whitelist.txt
